...
<body>
	...
	<jsp:param name="clazz" value= "add_admin"/>
	</jsp:include>

		<div class="main_content" id="tabs">
			<h2 class="main_content_title">创建管理员</h2>
			<ul class="title_option">
				<li><a href="javascript:;" class="select">创建管理员</a></li>
			</ul>
						...
						<li>
							...
							<div class="check-authority">
								<ul class="checkul">
									...
									<input type="checkbox" class="useCB checkinput" name="userAdvice" onclick="useCheckBoxFun(this)" data-labelauty="查看用户建议">
	...
	<script src="/Express/js/add_admin.js"></script>
