...
<head>
	...
	<link rel="stylesheet" href="/Express/css/finish_order.css">
</head>
<body>
	<!-- 头部 -->
	...
	<jsp:param name="clazz" value= "finish_order"/>
	</jsp:include>
	
	<!-- 主内容 -->
		<div class="main_content" id="tabs">
			<h2 class="main_content_title">已完成订单</h2>
			<h4 class="main_content_title">
				快递员：<input type="text" placeholder="姓名" id="username"/>&nbsp;&nbsp;&nbsp;&nbsp;
				订单完成日期：<input type="date" id="start"/>&nbsp;—&nbsp;<input type="date" id="end"/>&nbsp;&nbsp;&nbsp;&nbsp;
				<button class='btn ok timeselect'>开始查找</button>	
			</h4>
			<h5></h5>
			...
			<div class="finish_order_box" id="fragment-1">
			...
			<div class="finish_order_box Order_details" id="fragment-2">
	...
	<script src="/Express/js/finish_order.js"></script>
